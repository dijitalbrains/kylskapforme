<x-app-layout>
    ...
    <p>Ett fristående kylskåp kräver egentligen bara ett eluttag, och eventuellt en slang för vattentillförsel, och du
        kan placera det ungefär var som<br>
    ...
    <p>Att få inbyggda kyl- och frysskåp på plats i köket kräver både lite mer tid och en något större arbetsinsats. Du
        har dock mer spelrum för din<br>
        personliga smak, ditt kök kan se ut precis som du själv väljer. Du är inte heller låst vid en enhetlig lösning,
        eftersom du kan dela upp vitvarorna.<br>
        Det innebär att du exempelvis kan välja att ha en liten kyl eller en liten frys installerad under en köksbänk,
        eller någon annan lösning som<br>
    ...
    <p>Det är oftast dyrare än en fristående modell med samma specifikationer<br>
        ...
        Om du behöver byta ut kylskåpet i framtiden, det är till exempel inte säkert att din köksleverantör har samma
        luckor i sitt sortiment</p>
